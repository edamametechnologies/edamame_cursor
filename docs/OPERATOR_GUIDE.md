...
2. Run `edamame_cursor_control_center` from Cursor and save the local endpoint + PSK explicitly.
...
- Missing PSK file: use `edamame_cursor_control_center` to paste and store a fresh local PSK.
