...
no reasonable Cursor behavioral model would include.
...
Designed to run under Cursor's process tree so the sessions pass the
scope_parent_paths filter.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Trigger divergence detection by generating unexplained "
                    "network destinations from a Cursor-parented process."
    )
