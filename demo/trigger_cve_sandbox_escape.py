...
This script is designed to be run from a Cursor terminal -- the Python
process itself has normal Cursor parent lineage, but the spawned network
child has /tmp ancestry which is exactly what the sandbox_exploitation
check looks for.
